import { buildMetadata, DEFAULT_API_SERVER } from "./metadata.js";
import { encodeMessage, iterFields, asString } from "./wire.js";
...
export async function mintUserJwt(
	...
	const metadata = buildMetadata({ apiKey, kind: "chat" });
